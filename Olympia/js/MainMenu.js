...
//    music.stop();
	...
	function showInstructions() {
      ...
      nextButton = game.add.button(400 - 128, 448, 'buttons', showInstructions, null, 7, 9, 11);
		}
		else if (page == 2) {
			page++;
      ...
      closeButton = game.add.button(400 - 128, 448, 'buttons', showInstructions, null, 6, 8, 10);
		}
		else {
			page = 1;
			closeFrame.kill();
  ...
  return {
	  create: function () {
		...
		//	buttonSelect.volume = .3;
			...
			let playButton = game.add.button(400 - 128, 353, 'buttons', startGame, null, 0, 2, 4);
			let instButtonFrame = game.add.sprite(400 - 132, 410, 'buttonFrame');
     	let instButton = game.add.button(400 - 128, 413, 'buttons', showInstructions, null, 1, 3, 5);
	  },
